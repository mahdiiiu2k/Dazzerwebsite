  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        ...
        <div className="luxury-border glass-card p-6 md:p-12 max-w-6xl mx-auto" style={{position: 'relative'}}>
          
          {/* Instagram Button - Positioned inside rectangle using absolute positioning */}
          <div style={{
            position: 'absolute',
            top: '20px',
            left: '50%',
