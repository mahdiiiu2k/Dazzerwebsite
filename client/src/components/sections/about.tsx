    ...
    <section id="about" ref={sectionRef} className="py-20 px-6">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 gradient-text">About Us</h2>
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
            We're a passionate team of web designers and developers who specialize in delivering complete websites for businesses in under 24 hours. Using modern tools and efficient processes, we help businesses establish their online presence quickly and professionally.
          </p>
        </div>
        ...
        <GlassCard className="text-center">
          ...
          <p className="text-gray-200">A dedicated team of designers and developers committed to delivering exceptional websites in record time</p>
        </GlassCard>
      </div>
    </section>
  );
