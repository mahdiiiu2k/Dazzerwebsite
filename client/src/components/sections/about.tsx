  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        ...
        {/* Instagram Button - Positioned to appear inside rectangle but actually outside */}
        <div style={{
          textAlign: 'center',
          position: 'relative',
          zIndex: 99999,
        ...
        <div className="luxury-border glass-card p-6 md:p-12 max-w-6xl mx-auto" style={{paddingTop: '60px'}}>
